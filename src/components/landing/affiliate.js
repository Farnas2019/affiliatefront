const Affiliate = () => {
  return (
    <>
      <div className=" flex justify-between items-center font-popins my-4 mx-10 space-x-10 md:flex-row flex-col bg-white pr-5">
        <div className=" flex justify-between bg-lprimary flex-col rounded-md w-64">
          <div className="flex justify-between flex-col rounded-md bg-primary py-5 px-5">
            <div className="flex justify-between flex-col rounded-md w-full">
              ...
              <div className="flex items-center justify-between pb-7 border-b ">
                ...
                <div className=" text-light"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
          ...
          <div className=" px-2 py-2 text-primary flex">
            <svg
        ...
        <div className="flex flex-col flex-grow my-5 md:my-0">
          <div className=" text-dprimary font-semibold text-4xl">Affliate</div>
          <div className="flex justify-between mb-10">
            <h5>
            <span className=" text-light">Portal</span> / Affiliate
            </h5>
            <h5 className=" text-light">These statistics are in realtime and update instantly</h5>
          </div>
          <div className="flex md:flex-row  justify-between md:space-x-10 flex-col ">
            <div className=" rounded-md shadow-md border flex flex-grow flex-col  px-4 py-4 my-2">
              ...
              <div className=" text-primary font-medium text-6xl">0</div>
          ...
          <div className=" rounded-md shadow-md border flex flex-grow flex-col px-4 py-4 my-10">
           <form className="flex border my-0.5 mx-0.5 ">
             <button className=" bg-primary px-4 py-4 text-white">
               Your refaral Link
             </button>
             <input type="text" className=" flex-grow felx px-5 text-lprimary" value=" https://www.tenplus.com/ref1234"/>
