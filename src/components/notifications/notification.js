  ...
  return (
    <>
      ...
      <div className=" flex-col border shadow-md mx-4 md:mx-44 my-10 rounded-md py-4 px-1 flex justify-between">
        ...
        <div className=" mx-3 my-2 px-5 bg-white flex justify-between py-6 border-l-4 border-dprimary hover:border-lprimary items-center hover:bg-dprimary hover:text-vlprimary text-dprimary" onClick={()=> setModal(true)}>
