...
const Refer= () => {
  ...
  return (
    <>
      ...
      <Greetings />
      <div class="w-full xl:w-8/12 mb-12 xl:mb-10 px-4 mx-auto mt-24 border rounded-lg  my-4">
        <div className="flex flex-row my-5 justify-between ">
          <h1 className=" font-bold text-primary">Refer a Friend</h1>{" "}
          <div className="flex">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded border-l-4 border-primary ">
          <div class="flex flex-row justify-between content-start items-center py-10 px-5 space-x-5 border-b  text-dprimary">
            <div className="flex flex-col ">
              <h1>Logo</h1>
            </div>
            <div className=" flex flex-col justify-between flex-grow ">
              <div className=" font-bold font-popins text-xl">
                Earn N2000 when you refer a friend
              </div>
              <div className=" font-semibold py-2">Here's how it works</div>
              <div className=" flex flex-row space-x-6">
                <div className=" w-1/6 flex py-2 text-sm">
                  {" "}
                  <div className=" text-4xl font-extralight "> 1.</div> Tell
                  Your friend about ten plus
                </div>
                <div className=" w-1/6 flex py-2 text-sm">
                  {" "}
                  <div className=" text-4xl font-extralight "> 2.</div> Your
                  Friend Signs up{" "}
                </div>
                <div className=" w-1/6 flex py-2 text-sm">
                  {" "}
                  <div className=" text-4xl font-extralight "> 3.</div> You Both
                  earn Reward
                </div>
              </div>
            </div>
          </div>
          <div class="flex flex-col justify-between items-centercontent-start py-2 px-5 space-x-5 border-b  text-dprimary items-center">
            <div className="flex flex-col ">
            ...
            <div className=" my-2">
              <form className="flex border my-0.5 mx-0.5 ">
                <button className=" bg-primary px-2 py-2 text-white">
                  Your refaral Link
                </button>
                <input
                  type="text"
                  className=" flex-grow felx px-5 text-lprimary"
        ...
        <div class="container mx-auto px-4">
           ...
           * After Your friend Register blablablalhldhfdfldshldshl
          </div>
        </div>
      </footer>
      </div>
